...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 23, 2025 at 04:06 PM
...
(14, 'greenfooter.png', '../../assets/uploads/greenfooter.png', 7);
...
--
ALTER TABLE `upload`
  MODIFY `file_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `upload`
  ADD CONSTRAINT `notesid` FOREIGN KEY (`notes_id`) REFERENCES `notes` (`notes_id`);
COMMIT;
